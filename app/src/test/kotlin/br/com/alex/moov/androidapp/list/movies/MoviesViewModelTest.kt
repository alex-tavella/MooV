...
package br.com.alex.moov.androidapp.list.movies

import br.com.alex.moov.BR
import br.com.alex.moov.androidapp.base.viewmodel.ViewModelTest
import br.com.alex.moov.androidapp.list.movie.MoviesViewModel
...
class MoviesViewModelTest : ViewModelTest<MoviesViewModel>() {
  ...
  override fun createViewModel(): MoviesViewModel = MoviesViewModel(SpiedMovieAdapter(appContext),
      interactor)
  ...
  @Test fun testViewModel() {
    ...
    firstPage.forEachIndexed { i, movie -> assertEquals(movie, capturedMovies.get(i)) }
  }
