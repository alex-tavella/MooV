...
class MovieRepositoryImplTest {
  ...
  fun setup() {
    movieRepositoryImpl = MovieRepositoryImpl(mockedMovieDataSource, mockedBookmarkDataSource,
        mockedMapper)
  }
  ...
  fun `get popular movies`() {
    runBlocking {
      ...
      whenever(mockedMovieDataSource.getMovies(any(), any(), any())).thenReturn(sourceMovieList)
      ...
      verify(mockedMovieDataSource).getMovies(pageCaptor.capture(), sortByCaptor.capture(),
